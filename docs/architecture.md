...
| 8   | Calendar                     | Day/week/month, filters, status colors, detail drawer, admin create/edit/move, range-bounded queries                                                                                                                                    |                                                        |
| 9   | Client dashboard             | Upcoming/past/cancelled, reschedule/cancel with policy messaging, profile, notification settings                                                                                                                                        |                                                        |
